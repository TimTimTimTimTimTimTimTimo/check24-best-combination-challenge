  ...
  function updateSelectedGames() {
    ...
    for (let orphanGame of orphan_games) {
      if (
        ...
        selectedTournamentIds.has(orphanGame.attributes.tournament_id) &&
        selectedDateRange.start < parseDate(orphanGame.attributes.date) &&
    ...
    <Carousel.Content>
        ...
        <Card.Root>
          ...
          <Card.Content class="flex flex-row h-80">
            ...
            <div class="flex flex-col max-w-fit">
              <h3 class="mb-2">
                {selectedTeamIds.size} gewählte{selectedTeamIds.size === 1
                  ? "s"
                  : ""} Teams
              </h3>
              <div
        ...
        <Card.Root>
          ...
          <Card.Content class="flex flex-row h-80">
            <Command.Root class="w-48 flex-shrink-0">
              ...
              <Command.List class="max-h-full">
                <Command.Empty>Kein Turnier gefunden.</Command.Empty>
                <Command.Group>
      ...
      <Carousel.Item class="md:basis-full lg:basis-1/5">
        <Card.Root>
          ...
          <Card.Content class="flex max-h-80 justify-center items-center p-10">
    ...
    <Carousel.Content class="mx-2">
      {#if combiResult}
        ...
        {#each single_combinations.toSorted((a, b) => {
          ...
          {@render CombinationCard("", game_count, orphan_count, single)}
        {/each}
      {:else}
...
{#snippet CombinationCard(
  ...
  <Carousel.Item class="md:basis-1/3 lg:basis-1/6 py-1">
    <Card.Root class="hover:shadow hover:scale-[1.01] transition-transform">
      <Card.Header class="h-32">
        <Card.Title class="flex justify-center items-center text-center h-14">
          {name}
        </Card.Title>
        <div class="h-14">
      ...
      <Card.Content>
        ...
        <Separator class="my-4" />
        <div>
          {combi.yearly_price_per_month_cents / 100}€ pro Monat im Jahresabo
        </div>
      </Card.Content>
    </Card.Root>
  </Carousel.Item>
